...
#ifndef MUSICTEST_SWIFT_H
#define MUSICTEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MusicTest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9MusicTest11AppDelegate")
...
SWIFT_CLASS("_TtC9MusicTest24CustomCollectionViewCell")
...
SWIFT_CLASS("_TtC9MusicTest13SceneDelegate")
...
@interface ViewController (SWIFT_EXTENSION(MusicTest)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
